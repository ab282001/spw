        ...
        <div className='d-flex justify-content-center footer-top'>
          ...
          <div className='mx-5'>
            ...
            <div className='d-flex flex-column align-items-center'>
              <Link href={'/'}><a className='text-decoration-none text-secondary'>Home</a></Link>
              <Link href={'/our-products/NewItems'}><a className='text-decoration-none text-secondary'>Our Products</a></Link>
              <Link href={'/our-profile'}><a className='text-decoration-none text-secondary'>Our Profile</a></Link>
              <Link href={'/write-to-us'}><a className='text-decoration-none text-secondary'>Write to us</a></Link>
            </div>
          </div>
          {/* Quick Links */}
          <div className='mx-5'>
